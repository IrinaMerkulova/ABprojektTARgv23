...
--- muuta tabeli Person. kustutamine FK
alter table Person
drop constraint tblPerson_GenderId_FK

-- kirja lisamine tabelisse Gender
insert into Gender (Id, Gender)
values (3, 'Unknown')
...
---kirja lisamine tabelisse Person
alter table Person
add Age nvarchar(10)
...
--muuta tabeli Person. Lisamine vanusepiirangud
alter table Person
...
--kustutamine tabelis Person kirja ID = 8
select * from Person
go
...
-- kirjuta otsing tabelisse Person kust 'Age' =100 või 50 või 20 
select *from Person where Age = 100 or 
Age = 50 or Age = 20
select * from Person where Age in (100, 50, 20)


--- otsige tabelisse Person linna esimese tähega 'n' ja email 
select * from Person where City like 'n%'
select * from Person where Email like '%@%'

-- otsige tabelisse Person emal ilma '@'
...
--- otsige tabelisse Person linna Gotham ja New York vanusega >= 40
...
--- kolm sissekannet kõrgema vanusega nimesid
select * from Person
